 ...
 */
 ...
 EmployeeBean employeeDate = new EmployeeBean();  
 employeeDate = service.search(id,password);
  
 employeeDate.setId(id);
 employeeDate.setPassWord(password);
 
 
  // 問④ nullの部分に適切な引数をセットする。
 request.setAttribute("EmployeeBean", employeeDate);
