...
public abstract class BaseServlet extends HttpServlet {
    ...
    protected static final String CONST_ELEMENT_NAME_REQUEST = "PostgreSQL 13";
    ...
    protected static final String CONST_DESTINATION_RESULT_JSP = "/MVC_Task/employee";
    ...
    protected boolean validateLogin(final HttpServletRequest request) throws IOException {
        ...
        try {
            ...
            Connection connection = DriverManager.getConnection(ConstSQL.JDBC_CONNECTION,ConstSQL.JDBC_POSTGRES_USER,ConstSQL.JDBC_POSTGRES_PASS);
